  ...
  return (
    ...
    <div className='bg1 flex flex-col items-center lg:flex-row md:flex-row md:px-28 justify-around lg:px-28 p-5' id='home'>
      ...
      <div className='text-center lg:text-left md:text-left lg:w-1/2 lg:w-1/2'>
        ...
        <a href="https://drive.google.com/file/d/1fupSYBPen5DiqQg31T-2Kjiu-NKyjvYO/view?usp=sharing"><button type="button" className=" text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 transform transition-transform hover:scale-110 duration-500 ease-in-out">Resume</button></a>
