  ...
  return (
    <div className="text-center mt-7">
      ...
      <div className="container mx-auto flex flex-wrap justify-center mt-5 ">
        <div className="max-w-sm rounded-2xl overflow-hidden shadow-md m-4 border shadow-blue-900 shadow-xl">
          <img
        ...
        <div className="max-w-sm rounded-2xl border overflow-hidden shadow-md m-4 shadow-sky-900 shadow-xl">
          <img
      ...
      <div className="container mx-auto flex mt-10 flex-wrap justify-center">
        <div className="max-w-sm rounded-2xl overflow-hidden shadow-md m-4 shadow-purple-500 shadow-xl border">
          <img
