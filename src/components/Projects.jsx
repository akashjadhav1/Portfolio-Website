    ...
    <div className="mt-7">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col rounded-2xl border overflow-hidden m-4 shadow-sky-900 shadow-xl sm:w-full lg:w-full"
        >
          <img
          ...
          <div className="px-6 py-4 flex-grow">
            <div className="font-bold text-xl mb-2">Chat App</div>
            <p className="text-gray-500 text-base font-serif">
            A chat app allows users to communicate in real-time through text
              messages, group chats, and seamless multimedia sharing. It
              includes features like responsive design, user authentication, and
              the ability to create and manage group conversations.
            </p>
          </div>
          <div className="flex justify-around items-baseline pt-2 pb-4">
            <a href="https://chat-app-chi-gilt.vercel.app/">
            ...
            <a href="https://github.com/akashjadhav1/chat_app.git">
